...
interface MultiSettingsModalProps {
  onEditLobby: ({
    lobbySettings,
    lobbyName,
  }: {
...
const MultiSettingsModal: React.FC<MultiSettingsModalProps> = ({ onEditLobby, lobby }) => {
  const [isLoading, setIsLoading] = useState(false);
  const [lobbyName, setLobbyName] = useState<string>(lobby.name ?? '');
...
export default MultiSettingsModal;
